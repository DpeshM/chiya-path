...
const MenuGrid = ({ menuItems, selectedTable, selectedSeat, onAddItem, onBack, groupByCategory }) => {
  return (
    <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 border-2 border-orange-500">
      ...
      {Object.entries(groupByCategory(menuItems)).map(([category, items]) => (
        <div key={category} className="mb-4 sm:mb-6">
          <h3 className="text-base sm:text-lg font-semibold text-black mb-2 sm:mb-3 border-b-2 border-orange-500 pb-2">
            {category}
          </h3>
